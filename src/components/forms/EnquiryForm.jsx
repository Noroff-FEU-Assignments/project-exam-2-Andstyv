...
import { StyledEnquiryFormRow, StyledLoginFieldset } from "../forms/forms.styles";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <StyledLoginFieldset style={{ boxShadow: "none", padding: "5px" }} disabled={submitting}>
        <StyledEnquiryFormRow style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div className="message" style={{ textAlign: "center", color: "var(--color-success)" }}>
